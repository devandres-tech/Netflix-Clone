...
import { IAction, IfetchMovieDetails, IfetchSearchMovie } from '../../types';
...
export const fetchMovieDetails: IfetchMovieDetails = (mediaType: string, mediaId: number) => {
...
export const fetchSearchMovie: IfetchSearchMovie = (searchTerm: string) => {
  return async (dispatch: Dispatch<IAction>) => {
    try {
